      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildCategorySection('Macarons', Menu.Macarons),
            _buildCategorySection('Горячий кофе', Menu.Madlens),
            _buildCategorySection('Латте', Menu.Croissants),
            _buildCategorySection('Холодный кофе', Menu.Cheesecakes),
            _buildCategorySection('Десерты', Menu.Coffee),
          ],
        ),
      ),
    );
